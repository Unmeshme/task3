...
func test_build_keyboard() -> void:
	...
	for m_key_data in Globals.Key_info_t:
		#here we create all the keys with simple logic
		#no need to sort anything either because I have created the keyboard as it should
